...
namespace PrimeTweenDemo {
    ...
    public class TypewriterAnimatorExample : MonoBehaviour {
        ...
        [SerializeField]
        AnimationType animationType = AnimationType.WithPunctuations;

        [SerializeField]
        float charsPerSecond = 40f;

        [SerializeField]
        int pauseAfterPunctuation = 20;
#if TEXT_MESH_PRO_INSTALLED
        ...
        void Awake() {
            ...
            text.text =
                "This text is <color=orange>animated</color> with <b>zero allocations</b>, see <i>'TypewriterAnimatorExample'</i> script for more details.\n\n"
                + "PrimeTween rocks!";
        }
        ...
        public Tween TypewriterAnimationWithPunctuations() {
            ...
            return Tween.Custom(
                ...
                remappedCount,
                duration,
                (t, x) => t.UpdateMaxVisibleCharsWithPunctuation(x),
                Ease.Linear
            );
        }
