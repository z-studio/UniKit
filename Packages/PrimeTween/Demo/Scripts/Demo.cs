...
namespace PrimeTweenDemo {
    public class Demo : MonoBehaviour {
        ...
        [SerializeField]
        Slider sequenceTimelineSlider;

        [SerializeField]
        Text pausedLabel;

        [SerializeField]
        Button animateAllPartsButton;

        [SerializeField]
        TypewriterAnimatorExample typewriterAnimatorExample;
        ...
        void UpdateSlider() {
            ...
            if (isSequenceAlive) {
                ...
                sequenceTimelineSlider.value =
                    animateAllSequence
                        .progressTotal; // Unity 2018 doesn't have SetValueWithoutNotify(), so use notifySliderChanged instead
