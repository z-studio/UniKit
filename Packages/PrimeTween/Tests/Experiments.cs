...
public class TweenData<T> where T : struct {
    ...
    /*public TweenData(TweenType tweenType, Object target, TweenSettings<T> data) {
        this.tweenType = tweenType;
        this.target = target;
        this.data = data;
    }

    public TweenData(TweenSettings<T> data, Action<T> customSetter) {
